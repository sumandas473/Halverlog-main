    ...
    >
      ...
      <div className="flex flex-col justify-evenly gap-6 mt-6">
        ...
        <div className="flex w-full justify-center">
          <button className="w-[80%] items-center justify-center bg-[rgba(82,182,225,1)] py-3 rounded-3xl text-xs shadow-[-3px_-2px_4px_0px_rgba(255,255,255,1),2px_4px_4px_0px_rgba(0,0,0,0.34)] hover:scale-110">
            FRIEND PROFILE
          </button>
        </div>
      </div>
